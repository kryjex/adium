...
public final class PluginManager {
    ...
    /// This is ~/.fluorite/plugins. Installed plugins land here, outside the app bundle.
    nonisolated public static var userPluginsDirectory: URL {
        let dir = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".fluorite", isDirectory: true)
    ...
    /// their plugins here. Fluorite loads these files but never writes
    /// to this directory.
    ...
    private func dataDirectory() -> URL {
        fileManager.homeDirectoryForCurrentUser.appendingPathComponent(".fluorite", isDirectory: true)
    }
