...
public final class ChatLogStore {
    ...
    public var logsDirectory: URL {
        ...
        let fluoriteLogs = appSupport.appendingPathComponent("Fluorite/Logs", isDirectory: true)
        try? fileManager.createDirectory(at: fluoriteLogs, withIntermediateDirectories: true)
        return fluoriteLogs
    }
