...
public struct BackupManifest: Codable {
    ...
    public init(app: String = "AdiumSwift", version: String = "1.0", createdAt: Date = Date()) {
        self.app = app
...
public final class BackupManager {
    ...
    public var dataDirectory: URL {
        ...
        let adiumDir = userHome.appendingPathComponent(".adium-swift", isDirectory: true)
        try? fileManager.createDirectory(at: adiumDir, withIntermediateDirectories: true)
        return adiumDir
    }
    ...
    public func promptExportBackup(window: NSWindow? = nil, completion: @escaping (Result<URL, Error>) -> Void) {
        ...
        panel.nameFieldStringValue = "AdiumSwift_Backup_\(dateStr).tar.gz"
